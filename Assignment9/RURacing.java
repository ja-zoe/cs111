...
public class RURacing {
    ...
    public static int countRoadLength(char[][] map) {
        int len = map.length;
        int count = 0;
        for (int i = 0; i < len; i++) {
	...
	// WRITE YOUR CODE HERE
        int n = countRoadLength(map);
        int[] coords = moveRacer(0, 0, n, map);
        System.out.println("Racer1 is at: (" + coords[0] + "," + coords[1] + ")");
    }
	...
	// WRITE YOUR CODE HERE
        int n = countRoadLength(map) - 1;
        int[] coords = moveRacer(0, 0, 1, map);
        for (int i = 2; n > 0; i *= 2) {
            System.out.println("Racer2 is at: (" + coords[0] + "," + coords[1] + ")");
            coords = moveRacer(coords[0], coords[1], i, map);
             n -= i;
        }
	...
	// WRITE YOUR CODE HERE
        ...
        int[] coords = moveRacer(0, 0, 1, map);  
        for (int i = 2; i <= n; i++) {
            System.out.println("Racer3 is at: (" + coords[0] + "," + coords[1] + ")");
            coords = moveRacer(coords[0], coords[1], 1, map);
        }
	...
	// WRITE YOUR CODE HERE
        ...
        for (int i = 1; i < n; i++) {
            for (int j = 1; j < n; j++) {
                System.out.println("Racer4 is at: (" + coords[0] + "," + coords[1] + ")");
            }
            coords = moveRacer(coords[0], coords[1], 1, map);
        }
